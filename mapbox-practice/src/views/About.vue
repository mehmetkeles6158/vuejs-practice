...
export default {
  data: function () {
    return {
      message: "Welcome to About-Vue.js!",
    };
  },
  mounted: function () {
    this.generateMap();
  ...
  methods: {
    generateMap: function () {
      ...
      mapboxgl.accessToken =
        "pk.eyJ1IjoibWVobWV0azYxNTgiLCJhIjoiY2t3YmlxM3l2MnVpOTJubmhhcTg0bnVpdSJ9._PYMxx9LYNNuT8Z9I0q5Eg";
      (async () => {
        ...
        const [pinRouteGeojson] = await Promise.all([
          fetch("https://docs.mapbox.com/mapbox-gl-js/assets/route-pin.geojson").then((response) => response.json()),
          map.once("load"),
        ]);
